                ...
                <div class="col-md-8">
                    <div class="stage">
                        <div class="student-body">
                            ...
                            $room_status=1;
                            $avail='available';
                            $query="SELECT room.id,hostel.hostelName,room.roomname,room.roomprice,room.roomImage1 from room join hostel on hostel.id=room.hostelid  WHERE room.roomStatus=? AND room.roomavailability=? ORDER BY RAND() LIMIT 6";
                            $room_to_select=$con->prepare($query);
                            $room_to_select->bind_param('is',$room_status,$avail);
